...
class SliderController extends VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $slider->active =  $request->active != null ? 1 : 0;
        ...
        if ($update == 1 && $slider->active == 0) {

            return $redirect->with([
                'message'    =>   "Done Cancelled  this slider",
                'alert-type' => 'success',
            ]);
        } elseif ($update == 1 && $slider->active == 1) {
            return $redirect->with([
                'message'    =>   "Done Active  this slider",
                'alert-type' => 'success',
            ]);
        }
