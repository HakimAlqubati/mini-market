...
class MainGroupController  extends  VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $mainGroup = MainGroup::where('id', $id)->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->file('image')) {
            ...
            Storage::disk('local')->put('public/main-groups' . '/' . $fileName, $img, 'public');
            $fileName = 'main-groups/' . $fileName;
        }
        ...
        $mainGroup->english_name = $request->english_name;
        $mainGroup->description = $request->description;
        if ($fileName != null) {
            $mainGroup->image = $fileName;
        }
        $mainGroup->active = $request->active != null ? 1 : 0;


        $update =  $mainGroup->save();
        if ($update == 1) {
