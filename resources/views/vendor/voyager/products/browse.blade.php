...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            ...
            {{-- <button type="button" class="btn btn-success btn-add-new" data-toggle="modal" data-target="#add-modal">Add new
        ...
        <a  class="btn btn-primary" href="{{ url('/'). '/products/export'}}" >
                                    ...
                                    @foreach ($dataTypeContent as $data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img style="height: 130px;width: 150px; border-radius: 15px;"
                                                    src={{ url('/') . '/storage/' . (str_contains($data->image, ',') ? explode(',', $data->image)[0] : $data->image) }}
                                                    alt="">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">New main group</h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.myCheck').on('change', function(e) {
                ...
                var prodId = strValue[0]
                var active = strValue[1]

                if (active == 1) {
                    e.preventDefault();
                    jQuery.ajax({
                        url: '/spices-sys/an-active-product/' + prodId,
                        method: 'post',
                    ...
                    e.preventDefault();
                    jQuery.ajax({
                        url: '/spices-sys/active-product/' + prodId,
                        method: 'post',
                        success: function(result) {
                            console.log('ddd')
                            jQuery('.alert').show();
