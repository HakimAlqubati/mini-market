        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <form action={{ $edit ? url('/update-slider', [$dataTypeContent->getKey()]) : url('/add-slider') }}
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="file" name="images[]" class="form-control" id="validationCustom01"
                                placeholder="group name here" multiple>
