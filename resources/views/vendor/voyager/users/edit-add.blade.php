                ...
                <div class="col-md-8">
                    <div class="panel panel-bordered">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="phone_no">{{ __('phone_number_label') }}</label>
                                <input type="text" class="form-control" id="phone_no" name="phone_no"
                                    placeholder="{{ __('phone_number_label') }}"
                                    value="{{ old('phone_no', $dataTypeContent->phone_no ?? '') }}">
                            </div>
                          ...
                          <!--  <div class="form-group">
                                ...
                                <select class="form-control select2" id="locale" name="locale">
                                    ...
                                    <option value="ar" {{ Config::get('app.locale') == 'ar' ? 'selected' : '' }}>العربية
                                    </option>
                                    <option value="en" {{ Config::get('app.locale') == 'en' ? 'selected' : '' }}>English
                                    </option>
                                </select>
                            </div> -->
