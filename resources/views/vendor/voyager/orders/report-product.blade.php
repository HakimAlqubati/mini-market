            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <form class="form-inline form-filter" method="GET"
                        action="<?php echo url('/'); ?>/admin/report-basedon-product">
                                ...
                                @foreach ($final as $value)
                                    <tr>
                                        <td>
                                            ...
                                            <a
                                                href="{{ url('/') . '/admin/orders/' . $value->order_id }}">{{ $value->order_id }}</a>
